...
void kernel_prepare(__global   sha512_salt     * salt,
	...
	i = 0;
        /* ***  j = 0 -> index[0] = 0, *0, 000*  *** */
	//else (j & 1)
	work_memory[gid + (i * 64) + 0] = alt_result[0].mem_64[0];
	work_memory[gid + (i * 64) + 1] = alt_result[1].mem_64[0];
	work_memory[gid + (i * 64) + 2] = alt_result[2].mem_64[0];
	work_memory[gid + (i * 64) + 3] = alt_result[3].mem_64[0];
	work_memory[gid + (i * 64) + 4] = alt_result[4].mem_64[0];
	work_memory[gid + (i * 64) + 5] = alt_result[5].mem_64[0];
	work_memory[gid + (i * 64) + 6] = alt_result[6].mem_64[0];
	work_memory[gid + (i * 64) + 7] = alt_result[7].mem_64[0];

	//else (j & 1)
	work_memory[gid + (i * 64) + 8] =  p_sequence[0].mem_64[0];
	work_memory[gid + (i * 64) + 9] =  p_sequence[1].mem_64[0];
	work_memory[gid + (i * 64) + 10] = p_sequence[2].mem_64[0];
	total = 64 + passlen;

	i = 1;
        /* ***  j = 3 -> index[3] = 1, *3, 101*  *** */
	//(j & 1)
	work_memory[gid + (i * 64) + 0] = p_sequence[0].mem_64[0];
	work_memory[gid + (i * 64) + 1] = p_sequence[1].mem_64[0];
	work_memory[gid + (i * 64) + 2] = p_sequence[2].mem_64[0];
	total = passlen;

	//(j % 7)
	APPEND_BE(work_memory[gid + (i * 64) + 3], p_sequence[0].mem_64[0], total);
	APPEND_BE(work_memory[gid + (i * 64) + 3], p_sequence[1].mem_64[0], total + 8);
	APPEND_BE(work_memory[gid + (i * 64) + 3], p_sequence[2].mem_64[0], total + 16);
	total += passlen;

	//(j & 1)
	APPEND_BE(work_memory[gid + (i * 64) + 3], alt_result[0].mem_64[0], total);
	APPEND_BE(work_memory[gid + (i * 64) + 3], alt_result[1].mem_64[0], total + 8);
	APPEND_BE(work_memory[gid + (i * 64) + 3], alt_result[2].mem_64[0], total + 16);
	APPEND_BE(work_memory[gid + (i * 64) + 3], alt_result[3].mem_64[0], total + 24);
	APPEND_BE(work_memory[gid + (i * 64) + 3], alt_result[4].mem_64[0], total + 32);
	APPEND_BE(work_memory[gid + (i * 64) + 3], alt_result[5].mem_64[0], total + 40);
	APPEND_BE(work_memory[gid + (i * 64) + 3], alt_result[6].mem_64[0], total + 48);
	APPEND_BE(work_memory[gid + (i * 64) + 3], alt_result[7].mem_64[0], total + 56);
	total += 64;

	i = 2;
        /* ***  j = 35 -> index[35] = 2, *35, 110*  *** */
	//(j & 1)
	work_memory[gid + (i * 64) + 0] = p_sequence[0].mem_64[0];
	work_memory[gid + (i * 64) + 1] = p_sequence[1].mem_64[0];
	work_memory[gid + (i * 64) + 2] = p_sequence[2].mem_64[0];
	...
	//(j % 3)
	APPEND_BE(work_memory[gid + (i * 64) + 3], temp_result[0].mem_64[0], total);
	APPEND_BE(work_memory[gid + (i * 64) + 3], temp_result[1].mem_64[0], total + 8);
	total += saltlen;
...
void kernel_crypt(__constant sha512_salt     * salt,
    ...
    //Do the job
    sha512_crypt(salt->length, keys_buffer[gid].length, salt->final, HASH_LOOPS,
		 &tmp_memory[gid], &work_memory[gid * 64]);
}
