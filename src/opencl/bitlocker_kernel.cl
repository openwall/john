                                        ...
                                        unsigned int IV8, unsigned int IV12)
{
	...
	while(globalIndexPassword < numPassword)
	{
		...
		schedule0 = (((unsigned int)w_password[(indexW+0)]) << 24) | 0 | (((unsigned int)w_password[(indexW+1)]) <<  8) | 0;
		schedule1 = (((unsigned int)w_password[(indexW+2)]) << 24) | 0 | (((unsigned int)w_password[(indexW+3)]) <<  8) | 0;
		schedule2 = (((unsigned int)w_password[(indexW+4)]) << 24) | 0 | (((unsigned int)w_password[(indexW+5)]) <<  8) | 0;
		schedule3 = (((unsigned int)w_password[(indexW+6)]) << 24) | 0 | (((unsigned int)w_password[(indexW+7)]) <<  8) | 0;
		schedule4 = (((unsigned int)w_password[(indexW+8)]) << 24) | 0 | (((unsigned int)w_password[(indexW+9)]) <<  8) | 0;
	   	schedule5 = (((unsigned int)w_password[(indexW+10)]) << 24) | 0 | (((unsigned int)w_password[(indexW+11)]) <<  8) | 0;
		schedule6 = (((unsigned int)w_password[(indexW+12)]) << 24) | 0 | (((unsigned int)w_password[(indexW+13)]) <<  8) | 0;
		schedule7 = (((unsigned int)w_password[(indexW+14)]) << 24) | 0 | (((unsigned int)w_password[(indexW+15)]) <<  8) | 0;
...
/*
        ...
        {
            printf("w_password[(indexW+0)]: %c - %x\n", w_password[(indexW+0)], w_password[(indexW+0)]);
            printf("schedule0: %x\n", schedule0);
            printf("schedule1: %x\n", schedule1);
            printf("schedule2: %x\n", schedule2);
            printf("schedule3: %x\n", schedule3);
