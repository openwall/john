...
inline void sha512_digest_move_R(sha512_ctx * ctx,
                                 uint64_t   * result,
                                 const int size) {
...
inline void sha512_digest_move_G(         sha512_ctx * ctx,
...
//TODO:  dar um jeito de substituir todos os ctx_update abaixo.
//Não executar SWAP tantas vezes.
