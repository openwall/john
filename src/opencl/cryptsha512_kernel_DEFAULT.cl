...
inline void insert_to_buffer(sha512_ctx    * ctx,
    ...
    for (uint32_t i = 0; i < len; i++)
        PUT(ctx->buffer->mem_32, ctx->buflen + i, GETCHAR(string, i));
...
inline void ctx_append_1(sha512_ctx * ctx) {
    ...
    PUT(ctx->buffer->mem_32, length, 0x80);

    while (++length & 7)
        PUT(ctx->buffer->mem_32, length, 0);
...
inline void sha512_crypt(__global   sha512_salt     * salt_data,
                  __global   sha512_password * pass_data,
                             sha512_buffer   * fast_tmp_memory,
...
__kernel
inline void kernel_crypt(__global   sha512_salt     * salt,
                  __global   sha512_password * pass_data,
