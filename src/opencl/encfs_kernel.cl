/*
 * Modified by Dhiru Kholia <dhiru at openwall.com> for ZIP AES format.
 *
...
__kernel void encfs(__global const encfs_password * inbuffer,
    __global encfs_hash * outbuffer, __global const encfs_salt * salt)
{
