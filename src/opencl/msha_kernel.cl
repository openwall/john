...
#pragma unroll
    ...
    digest[gid] = SWAP32(Td[0]);
    digest[gid+1*num_keys] = SWAP32(Td[1]);
    digest[gid+2*num_keys] = SWAP32(Td[2]);
    digest[gid+3*num_keys] = SWAP32(Td[3]);
    digest[gid+4*num_keys] = SWAP32(Td[4]);
}
