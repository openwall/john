...
#define PLAINTEXT_LENGTH        255 /* actual max in AIX is 255 */
...
static struct fmt_tests aixssha_tests1[] = {
	...
	/* Full 125 byte PW (longest JtR used to handle).  generated by pass_gen.pl */
...
/*
 * We use MAX_PLAINTEXT_LENGTH rather than PLAINTEXT_LENGTH here to avoid
 * excessive cache aliasing since our (PLAINTEXT_LENGTH + 1) would be 256.
 */
static char (*saved_key)[MAX_PLAINTEXT_LENGTH + 1];
