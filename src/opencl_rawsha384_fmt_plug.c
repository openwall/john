 ...
 *
 * More information at https://openwall.info/wiki/john/OpenCL-RAWSHA-384
 *
...
#if FMT_EXTERNS_H
extern struct fmt_main fmt_opencl_rawsha384;
#elif FMT_REGISTERS_H
john_register_one(&fmt_opencl_rawsha384);
#else
...
#define FORMAT_LABEL            "raw-SHA384-opencl"
#define FORMAT_NAME         ""

#define ALGORITHM_NAME          "SHA384 OpenCL"
...
static void build_kernel()
{
	...
	char *task = "$JOHN/opencl/sha384_kernel.cl";
...
#endif
	binary = (uint64_t *) sha384_common_binary_BE(source);
...
/* ------- Format structure ------- */
struct fmt_main fmt_opencl_rawsha384 = {
	{
		FORMAT_LABEL,
		FORMAT_NAME,
		ALGORITHM_NAME,
