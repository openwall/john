...
static struct opt_entry opt_list[] = {
	...
	{"fix-state-delay", 0, 0, 0, OPT_REQ_PARAM,
		"%u", &options.max_fix_state_delay},
	{"field-separator-char", 0, 0, 0, OPT_REQ_PARAM,
		OPT_FMT_STR_ALLOC, &field_sep_char_str},
	{"config", 0, 0, 0, OPT_REQ_PARAM,
	...
	{"mkpc", 0, 0, 0, OPT_REQ_PARAM,
		"%u", &options.force_maxkeys},
	{"min-length", 0, 0, 0, OPT_REQ_PARAM,
		"%u", &options.force_minlength},
	{"max-length", 0, 0, 0, OPT_REQ_PARAM,
		"%u", &options.force_maxlength},
	{"max-run-time", 0, 0, 0, OPT_REQ_PARAM,
		"%u", &options.max_run_time},
	{"progress-every", 0, 0, 0, OPT_REQ_PARAM,
		"%u", &options.status_interval},
	{"regen-lost-salts", 0, 0, 0, OPT_REQ_PARAM,
		OPT_FMT_STR_ALLOC, &regen_salts_options},
	{"bare-always-valid", 0, 0, 0, OPT_REQ_PARAM,
