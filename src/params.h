...
#define PASSWORD_HASH_THRESHOLD_3	(PASSWORD_HASH_SIZE_2 / 5)
#define PASSWORD_HASH_THRESHOLD_4	(PASSWORD_HASH_SIZE_3 * 3 / 2)
#define PASSWORD_HASH_THRESHOLD_5	(PASSWORD_HASH_SIZE_4 / 3)
