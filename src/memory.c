...
/* Note: if -DDEBUG we get MEM_ALLOC_SIZE=0 from memory.h, turning this
   function to essentially be just a malloc() with additional alignment. The
   reason for this is it's way easier to track bugs that way. */
