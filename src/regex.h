...
/* require at least version 2.1.4 of rexgen */
#if (JS_REGEX_MAJOR_VERSION > 2) || ((JS_REGEX_MAJOR_VERSION == 2) && ((JS_REGEX_MINOR_VERSION > 1) || (JS_REGEX_BUILD_VERSION >= 4)))
...
#warning         At least version 2.1.4 is required!
#endif
#endif
#else
#define do_regex_hybrid_crack(a,word,b,c) crk_process_key(word)
