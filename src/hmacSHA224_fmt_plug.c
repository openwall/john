...
#pragma omp parallel for
...
#endif
	{
		...
		pclear = (unsigned int*)&crypt_key[index/SIMD_COEF_32*SHA256_BUF_SIZ*SIMD_COEF_32*4];
		for (i = 0; i < MAX_KEYS_PER_CRYPT; i++)
			pclear[28/4*SIMD_COEF_32+i/SIMD_COEF_32*SHA256_BUF_SIZ*SIMD_COEF_32] = 0x80000000;
...
#ifdef SIMD_COEF_32
// NOTE crypt_key is in input format (4 * SHA256_BUF_SIZ * SIMD_COEF_32)
#define HASH_OFFSET (index & (SIMD_COEF_32 - 1)) + ((unsigned int)index / SIMD_COEF_32) * SIMD_COEF_32 * SHA256_BUF_SIZ
