...
static void init(struct fmt_main *self)
{
	...
	prep_ipad = mem_calloc(self->params.max_keys_per_crypt *
	                       BINARY_SIZE_256, sizeof(*prep_ipad));
	prep_opad = mem_calloc(self->params.max_keys_per_crypt *
	                       BINARY_SIZE_256, sizeof(*prep_opad));
