 ...
 *
 * OpenSSL's EVP interface is used to provide AES-NI support when available.
 */

#include <string.h>

/* ---- Start AES-NI Modifications ---- */
#include <openssl/ssl.h>
#include <openssl/bio.h>
/* ---- End AES-NI Modifications ---- */
...
#define FORMAT_LABEL		"o5logon-aesni-opencl"
#define FORMAT_NAME		"Oracle O5LOGON protocol w/ OpenCL SHA1 and OpenSSL AES-NI support"
...
struct fmt_main fmt_opencl_o5logon_aesni = {
	{
		FORMAT_LABEL,
		FORMAT_NAME,
		ALGORITHM_NAME,
