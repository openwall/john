...
void dump_text_msg(const char *msg, const void *in, int len);

void dump_stuff_msg(const char *msg, const void *x, unsigned int size);
void dump_stuff_be_msg(const char *msg, const void *x, unsigned int size);

#if defined (SIMD_COEF_32) || defined(NT_X86_64) || defined (SIMD_PARA_MD5) || defined (SIMD_PARA_MD4) || defined (SIMD_PARA_SHA1)
void dump_stuff_mmx_msg(const char *msg, const void *buf, unsigned int size, unsigned int index);
// for flat input, we do want to see SHA512 without byte swapping.
void dump_stuff_mmx64_msg(const char *msg, const void *buf, unsigned int size, unsigned int index);
void dump_out_mmx_msg(const char *msg, const void *buf, unsigned int size, unsigned int index);
void dump_stuff_shammx_msg(const char *msg, const void *buf, unsigned int size, unsigned int index);
void dump_out_shammx_msg(const char *msg, const void *buf, unsigned int size, unsigned int index);
void dump_stuff_shammx64_msg(const char *msg, const void *buf, unsigned int size, unsigned int index);
void dump_out_shammx64_msg(const char *msg, const void *buf, unsigned int size, unsigned int index);
#endif
...
void dump_stuff_mpara_mmx_msg(const char *msg, const void *buf, unsigned int size, unsigned int index);
