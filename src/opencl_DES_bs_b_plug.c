...
static cl_mem buffer_map, buffer_raw_keys, buffer_cracked_hashes, buffer_bs_keys, buffer_hash_ids, buffer_bitmap_dupe, *buffer_uncracked_hashes = NULL, *buffer_processed_salts = NULL, buffer_unchecked_hashes;
