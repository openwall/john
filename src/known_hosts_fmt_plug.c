...
static void *get_salt(char *ciphertext)
{
	...
	q = strchr(p, '|');
	base64_convert(p, e_b64_mime, q-p, (char*)salt, e_b64_raw, sizeof(salt), flg_Base64_DONOT_NULL_TERMINATE, NULL);
...
static void *get_binary(char *ciphertext)
{
	...
	char *p;
	p = strrchr(ciphertext, '|') + 1;
	base64_convert(p, e_b64_mime, BINARY_ENCODED_SIZE, (char*)out, e_b64_raw, sizeof(buf.c), flg_Base64_DONOT_NULL_TERMINATE, NULL);
