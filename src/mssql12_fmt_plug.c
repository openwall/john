...
#else
static int get_hash_0(int index) { return ((ARCH_WORD_64*)crypt_out[index])[3] & 0xf; }
static int get_hash_1(int index) { return ((ARCH_WORD_64*)crypt_out[index])[3] & 0xff; }
static int get_hash_2(int index) { return ((ARCH_WORD_64*)crypt_out[index])[3] & 0xfff; }
static int get_hash_3(int index) { return ((ARCH_WORD_64*)crypt_out[index])[3] & 0xffff; }
static int get_hash_4(int index) { return ((ARCH_WORD_64*)crypt_out[index])[3] & 0xfffff; }
static int get_hash_5(int index) { return ((ARCH_WORD_64*)crypt_out[index])[3] & 0xffffff; }
static int get_hash_6(int index) { return ((ARCH_WORD_64*)crypt_out[index])[3] & PH_MASK_6; }
#endif

static int binary_hash_0(void *binary) { return ((ARCH_WORD_64*)binary)[3] & 0xf; }
static int binary_hash_1(void *binary) { return ((ARCH_WORD_64*)binary)[3] & 0xff; }
static int binary_hash_2(void *binary) { return ((ARCH_WORD_64*)binary)[3] & 0xfff; }
...
static int cmp_exact(char *source, int index)
{
	...
	SHA512_CTX ctx;
	ARCH_WORD_64 crypt_out[BINARY_SIZE / sizeof(ARCH_WORD_64)];
	int len;
	...
	alter_endianity_to_BE64(crypt_out, BINARY_SIZE/8);
#ifdef REVERSE_STEPS
