...
#endif
#  ifdef MD5_SSE_PARA
#   define ALGORITHM_NAME		BITS " " MD5_SSE_type  " " STRINGIZE(BY_X) "x" STRINGIZE(SIMD_COEF_32) "x" STRINGIZE(MD5_SSE_PARA)
#   define BSD_BLKS (MD5_SSE_PARA)
#  else
#   define ALGORITHM_NAME		BITS " " MD5_SSE_type  " " STRINGIZE(BY_X) "x" STRINGIZE(SIMD_COEF_32)
#   define BSD_BLKS 1
#  endif
#  ifdef SHA1_SSE_PARA
#   define ALGORITHM_NAME_S		BITS " " SHA1_SSE_type " " STRINGIZE(BY_X) "x" STRINGIZE(SIMD_COEF_32) "x" STRINGIZE(SHA1_SSE_PARA)
#  else
#   define ALGORITHM_NAME_S		BITS " " SHA1_SSE_type " " STRINGIZE(BY_X) "x" STRINGIZE(SIMD_COEF_32)
#  endif
#  ifdef MD4_SSE_PARA
#   define ALGORITHM_NAME_4		BITS " " MD4_SSE_type  " " STRINGIZE(BY_X) "x" STRINGIZE(SIMD_COEF_32) "x" STRINGIZE(MD4_SSE_PARA)
#  else
#   define ALGORITHM_NAME_4		BITS " " MD4_SSE_type  " " STRINGIZE(BY_X) "x" STRINGIZE(SIMD_COEF_32)
#  endif
