...
gcc dynamic_big_crypt_chopper.c -o dynamic_big_crypt_chopper
...
./dynamic_big_crypt_chopper BITS=32 HASH=MD5       PARAHASH=MD5       BIN_SZ=16 BIN_REAL_SZ=16 BE_HASH=0 JSWAPH=' '           JSWAPT=';'   HASH_CTX=MD5_CTX               HASH_Init=MD5_Init           HASH_Update=MD5_Update       HASH_Final=MD5_Final           SSEBody=SSEmd5body    SSE_LIMBS=4 SSEFLAGS=' '                    UNDEFINED=TRUNC_TO16                               < dynamic_big_crypt_hash.cin  >> xxx && exit 1
