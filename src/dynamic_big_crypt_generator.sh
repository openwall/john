...
perl ./dynamic_big_crypt_chopper.pl BITS=32 HASH=MD5        PARAHASH=MD5        BIN_SZ=16 BIN_REAL_SZ=16 BE_HASH=0 JSWAPH=' '           JSWAPT=';'   HASH_CTX=MD5_CTX                HASH_Init=MD5_Init            HASH_Update=MD5_Update       HASH_Final=MD5_Final            SSEBody=SSEmd5body    SSE_LIMBS=4 SSEFLAGS=' '                    UNDEFINED=TRUNC_TO16                                < dynamic_big_crypt_hash.cin  >> xxx
perl ./dynamic_big_crypt_chopper.pl BITS=32 HASH=MD4        PARAHASH=MD4        BIN_SZ=16 BIN_REAL_SZ=16 BE_HASH=0 JSWAPH=' '           JSWAPT=';'   HASH_CTX=MD4_CTX                HASH_Init=MD4_Init            HASH_Update=MD4_Update       HASH_Final=MD4_Final            SSEBody=SSEmd4body    SSE_LIMBS=4 SSEFLAGS=' '                    UNDEFINED=TRUNC_TO16                                < dynamic_big_crypt_hash.cin  >> xxx
perl ./dynamic_big_crypt_chopper.pl BITS=32 HASH=SHA1       PARAHASH=SHA1       BIN_SZ=20 BIN_REAL_SZ=20 BE_HASH=1 JSWAPH='JOHNSWAP('   JSWAPT=');'  HASH_CTX=SHA_CTX                HASH_Init=SHA1_Init           HASH_Update=SHA1_Update      HASH_Final=SHA1_Final           SSEBody=SSESHA1body   SSE_LIMBS=4 SSEFLAGS=' '                      DEFINED=TRUNC_TO16                                < dynamic_big_crypt_hash.cin  >> xxx
...
perl ./dynamic_big_crypt_chopper.pl BITS=32 HASH=PANAMA     PARAHASH=PANAMA     BIN_SZ=32 BIN_REAL_SZ=32 BE_HASH=0 JSWAPH=' '           JSWAPT=';'   HASH_CTX=sph_panama_context     HASH_Init=sph_panama_init     HASH_Update=sph_panama       HASH_Final=sph_panama_close     SSEBody=' '           SSE_LIMBS=0 SSEFLAGS=' '                      DEFINED=TRUNC_TO16 UNDEFINED=SIMD_PARA_PANAMA     < dynamic_big_crypt_hash.cin  >> xxx
perl ./dynamic_big_crypt_chopper.pl BITS=32 HASH=MD2        PARAHASH=MD2        BIN_SZ=16 BIN_REAL_SZ=16 BE_HASH=0 JSWAPH=' '           JSWAPT=';'   HASH_CTX=sph_md2_context        HASH_Init=sph_md2_init        HASH_Update=sph_md2          HASH_Final=sph_md2_close        SSEBody=' '           SSE_LIMBS=0 SSEFLAGS=' '                      DEFINED=TRUNC_TO16 UNDEFINED=SIMD_PARA_MD2        < dynamic_big_crypt_hash.cin  >> xxx
perl ./dynamic_big_crypt_chopper.pl BITS=32 HASH=SKEIN224   PARAHASH=SKEIN224   BIN_SZ=64 BIN_REAL_SZ=28 BE_HASH=0 JSWAPH=' '           JSWAPT=';'   HASH_CTX=sph_skein224_context   HASH_Init=sph_skein224_init   HASH_Update=sph_skein224     HASH_Final=sph_skein224_close   SSEBody=' '           SSE_LIMBS=0 SSEFLAGS=' '                      DEFINED=TRUNC_TO16 UNDEFINED=SIMD_PARA_SKEIN224   < dynamic_big_crypt_hash.cin  >> xxx
