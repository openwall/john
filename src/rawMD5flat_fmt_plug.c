...
#if SIMD_COEF_32 * 4 - 1 > 55
#define PLAINTEXT_LENGTH        55
#else
#define PLAINTEXT_LENGTH        (sizeof(vtype) - 1)
#endif
...
#define FORMAT_NAME             ""
#define ALGORITHM_NAME          "(experimental) MD5 " MD5_ALGORITHM_NAME
...
{
#ifdef SIMD_COEF_32
	int len = strnzcpyn((char*)saved_key[index], key, sizeof(saved_key[0]));
