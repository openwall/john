...
static struct fmt_tests s7_tests[] = {
	{"$s7$1$599fe00cdb61f76cc6e949162f22c95943468acb$002e45951f62602b2f5d15df217f49da2f5379cb", "123"},
	{NULL}
};
...
static int valid(char *ciphertext, struct fmt_main *self)
{
	...
	char *keeptr;
	int outcome;
	if (strncmp(ciphertext, "$s7$", 4) != 0)
		return 0;
	ctcopy = strdup(ciphertext);
	keeptr = ctcopy;
	ctcopy += 4;		/* skip over "$s7$" */
