...
* CREDITS (*) - credits
* AddressSanitizer-HOWTO.txt - Building JtR with AddressSanitizer (or ASan)
...
* PRINCE - howto prince mode in JtR
...
* README.7z2john.md - 7z2 credit in JtR
...
* Regen-Lost-Salts.txt - regen-lost-salt in JtR
* SIPcrack-LICENSE - the SIPcrack license
* SecureMode-tutorial.md - using JtR's SecureMode feature
* dynamic_history.txt - upto date history on dynamic_fmt.c file
* john-1.7.9-jumbo-7-licensing-stats.txt - license status for john-1.7.9-jumbo-7
* libFuzzer-HOWTO.txt - how to build libfuzzer
