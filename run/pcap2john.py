...
if __name__ == "__main__":
    ...
    for i in range(1, len(sys.argv)):
        ...
        pcap_parser_s7(sys.argv[j])
        pcap_parser_rsvp(sys.argv[j])
        pcap_parser_ntp(sys.argv[j])
        pcap_parser_krbpa(sys.argv[j])
        pcap_parser_isis(sys.argv[j])
        pcap_parser_hsrp(sys.argv[j])
